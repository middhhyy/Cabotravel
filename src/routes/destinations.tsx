...
export const Route = createFileRoute("/destinations")({
  head: () => ({
    meta: [
      { title: "Destinations — Cabo Tours & Travels" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Destinations — Cabo Tours & Travels" },
      {
        property: "og:description",
        content:
          "Explore Kerala, Kashmir, Dubai, Bali, Thailand, and Maldives. Book your dream trip with curated international and domestic tour plans.",
      },
      ...
      { name: "twitter:title", content: "Destinations — Cabo Tours & Travels" },
      {
        name: "twitter:description",
        content:
          "Explore Kerala, Kashmir, Dubai, Bali, Thailand, and Maldives. Book your dream trip with curated tour plans.",
      },
