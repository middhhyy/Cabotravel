...
const Testimonials = React.memo(function Testimonials() {
  const testimonials = [
    {
      quote: "I recently booked a Goa trip package with Cabo Tours and Travels, and it was truly one of the best travel experiences I've had. The package was budget-friendly and included everything – comfortable stay, sightseeing, and smooth transfers.",
      name: "AKASH DEV",
      location: "Google Review",
      stars: 5,
    },
    {
      quote: "Six of us, three generations, one Kerala houseboat — and not a single hiccup. The team was on WhatsApp every single day.",
      name: "THE MENON FAMILY",
      location: "Dubai",
      stars: 5,
    },
    {
      quote: "Our Maldives honeymoon was choreographed beautifully — from seaplane transfer to the candlelit dinner on the sandbank. Cabo handled every detail.",
      name: "AISHWARYA & ROHIT",
      location: "Bangalore",
      stars: 5,
    },
    {
      quote: "I'd never travelled internationally alone. Cabo did my visa, my Bali itinerary and stayed in touch the entire week. Felt safe the whole time.",
      name: "SARA K.",
      location: "Kochi",
      stars: 5,
    },
    {
      quote: "Superb service! Amal and Meera planned our Kerala tour exceptionally well. The driver was excellent, hotels were top-class, and everything went smoothly.",
      name: "NANDINI S.",
      location: "Google Review",
      stars: 5,
    },
    {
      quote: "Extremely professional and friendly agency. They managed our visit visa and flights to Dubai without any hassle. Highly recommended for family travel.",
      name: "VISHNU PRASAD",
      location: "Google Review",
      stars: 5,
    },
    ...
    <section className="py-20 md:py-24 lg:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        ...
        <div className="flex items-center justify-center gap-2 mb-10 text-sm">
          ...
          <span className="text-white/60">194 reviews on</span>
          <a
            href="https://search.google.com/local/writereview?fid=0x4838e0163407ab2b:0xd6d0a4454c3b9f24"
            target="_blank"
            rel="noreferrer"
            className="text-brand underline underline-offset-2 hover:text-white transition"
          >
            Google
          </a>
        </div>
        ...
        <div className="flex justify-center mt-12">
          <a
            href="https://maps.app.goo.gl/uUbX9azXidotMG6v5"
            target="_blank"
            rel="noreferrer"
